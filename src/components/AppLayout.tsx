        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <a href="/consent" className="hover:text-blue-200 transition-colors">
                Consent
              </a>
              <a href="/speech" className="hover:text-blue-200 transition-colors">
                Speech
              </a>
              <a href="/memory" className="hover:text-blue-200 transition-colors">
                Memory
              </a>
